...
<section>
	<div>
		<form id="tarefasForm" method="POST" action="<?php echo BASE_URL; ?>Form">
		  ...
		  <div class="form-group">
		    <label for="textareaTarefa">Digite sua Tarefa</label>
   			<textarea class="form-control" id="textareaTarefa" name="tarefa" rows="3" placeholder="Exemplo ir ao supermercado..."></textarea>
		  </div>
